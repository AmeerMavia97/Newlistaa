...
const sections = [
    ...
    },
    {
        ...
        id: "Platform",
        label: "1. Platform Purpose &amp; Eligibility",
        content: (
            <>
                <p className="font-Inter text-[12.5px] sm:text-[14.5px] 2xl:text-[16.5px] leading-[19px] sm:leading-[24px]">
                ...
                <p className="font-semibold text-[14.5px] sm:text-[16px]">By signing up, users agree:</p>
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="font-Inter text-[12.5px] sm:text-[14.5px] 2xl:text-[16.5px] leading-[19px] sm:leading-[24px]">
                    We do not form, arrange, or facilitate real estate syndications, joint ventures, or investment partnerships. Any discussions, negotiations, or agreements that occur between users are conducted independently and outside the scope of Newlista.
                </p>
                <p className="font-Inter text-[12.5px] sm:text-[14.5px] 2xl:text-[16.5px] leading-[19px] sm:leading-[24px]">
                    All property listings are submitted by third parties and are not verified by Newlista. Users are solely responsible for verifying the accuracy, completeness, and legitimacy of any listings, as well as conducting their own due diligence and obtaining professional advice before making investment or business decisions. Users must also ensure that their listings and communications comply with applicable laws, including, but not limited to, the Fair Housing Act, FTC advertising standards, anti-spam regulations, and other relevant federal, state, and local requirements.
                </p>
                <p className="font-Inter text-[12.5px] sm:text-[14.5px] 2xl:text-[16.5px] leading-[19px] sm:leading-[24px]">
                    Newlista does not screen, endorse, or guarantee the qualifications, financial capacity, or trustworthiness of any user. If you choose to connect, communicate, or transact with another user, whether through networking features, private messaging, or otherwise, you do so at your own risk.
                </p>
                <p className="font-Inter text-[12.5px] sm:text-[14.5px] 2xl:text-[16.5px] leading-[19px] sm:leading-[24px]">
                    Newlista is not liable for any losses, disputes, failed transactions, or damages of any kind arising from user-to-user interactions, including but not limited to investment decisions, partnerships, joint ventures, or other business dealings initiated through the platform.
                </p>
            </>
        ),
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">
                    Newlista does not facilitate, promote, or participate in the sale of securities, investment contracts, or other regulated financial interests and does not verify users’ compliance with any securities or investment laws.
                </p>
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">
                    Users are solely responsible for understanding and complying with all applicable securities, advertising, consumer protection, and anti-fraud laws before engaging in any investment-related discussions.
                </p>
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">
                    We strongly encourage users to consult with a licensed real estate attorney or syndication specialist and to review the official SEC (www.sec.gov) and FTC (www.ftc.gov) websites for guidance.
                </p>
            </>
        ),
    },
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">
                    Further details regarding the arbitration process are set forth in the Newlista Arbitration Policy, which is incorporated by reference into these Terms of Use. The Arbitration Policy is available upon request and governs all aspects of arbitration, including administration, rules, costs, and location
                </p>
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">
                    You waive any right to a jury trial, and you also waive the right to participate in a class action or class arbitration.
                    Further details regarding the arbitration process, including fees, procedures, and location, are provided in our full arbitration policy.
                </p>
            </>
        ),
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mt-3 font-bold">Enforcement & Reporting:</p>
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mt-3 font-bold">Data & Communication Consent</p>
                <ul className="mt-1 list-disc pl-6 space-y-1 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">
                    We strive to design our website and digital services in a manner that is consistent with recognized generally accessibility standards, such as the Web Content Accessibility Guidelines (WCAG), to the extent reasonably practicable.
                </p>
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">
                    If you experience difficulty accessing any part of the platform, please contact us at support@newlista.com. Upon request, we will make reasonable efforts to provide the information, service, or communication you require in an accessible format.
                </p>
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">
                    Please note that while we are continually working to improve accessibility, some content, features, or third-party integrations may not yet be fully compliant or may be outside of our control. In such cases, we will take commercially reasonable steps to assist you.
                </p>
            </>
        ),
    },
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">All payments are non-refundable, except as required by applicable law or expressly stated otherwise. Unless otherwise noted, subscriptions automatically renew at the end of each billing cycle at the then-current rate. You may cancel auto-renewal by updating your account settings prior to the renewal date; however, cancellation does not entitle you to a refund for the current billing period. </p>
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">You are solely responsible for paying any sales tax, use tax, or other transactional taxes imposed on your purchase. Newlista remains accountable for its own income taxes. </p>
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">Chargebacks, fraudulent payment disputes, or unpaid balances may result in account suspension or termination. You acknowledge and agree that Newlista is not responsible for any loss or damage arising from disputes with your payment method or payment processor. </p>
            </>
        ),
    },
    {
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">If your account is terminated due to a violation of these Terms, any prepaid fees are non-refundable, and you forfeit any remaining time on your subscription or membership. No credits or refunds will be issued for partial billing periods. </p>
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">The following provisions shall survive termination: intellectual property licenses granted to Newlista, disclaimers and limitations of liability, arbitration and dispute resolution provisions, obligations regarding payment and subscriptions, enforcement provisions, and any other obligations which by their nature are intended to survive termination. </p>
            </>
        ),
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">Any data collected will be anonymized and presented in aggregate form, and personally identifiable information will not be disclosed without your explicit consent. </p>
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">You retain all rights to the content you post, subject to the license granted to Newlista for the purposes described above. </p>
            </>
        ),
    },
    {
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">If you believe that content posted on Newlista infringes your copyright, you may submit a written notice to Newlista containing the following: </p>
                <ul className="mt-1 list-disc pl-6 space-y-1 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">
                ...
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">Newlista will respond to valid DMCA notices in accordance with the Digital Millennium Copyright Act (DMCA), including removing or disabling access to infringing content. </p>
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">Accounts belonging to users who repeatedly infringe copyrights may be terminated at Newlista’s sole discretion. </p>
            </>
        ),
    },
    {
        id: "Rights",
        label: "17. California Residents’ Rights (CCPA/CPRA)",
        content: (
            <>
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">
                ...
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">To exercise any of these rights, please get in touch with us at privacy@newlista.com. We will respond in accordance with applicable law.
                </p>
            </>
        ),
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">You agree to indemnify, defend, and hold harmless Newlista and its affiliates from and against any and all claims, liabilities, damages, losses, or expenses, including reasonable attorneys’ fees, arising out of or related to:
                </p>
                <ul className="mt-1 list-disc pl-6 space-y-1 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">
                ...
                <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">This indemnification obligation survives the termination of your account and your use of Newlista. In no event shall Newlista’s total aggregate liability to you for all claims arising out of or relating to these Terms or your use of the platform exceed the total amount of subscription or service fees you have paid to Newlista in the twelve (12) months immediately preceding the event giving rise to the claim. </p>
              <p className="mt-2 font-Inter text-[12.5px] leading-[19px] sm:leading-[24px] sm:text-[14.5px] 2xl:text-[16.5px]">Newlista reserves the right to update or modify these Terms of Use at any time. Changes will become effective upon posting to the platform, and continued use of Newlista after such changes constitutes acceptance of the revised Terms. </p>
            </>
        ),
    },
];
